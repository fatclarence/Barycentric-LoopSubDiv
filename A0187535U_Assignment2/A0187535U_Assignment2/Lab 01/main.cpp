...
void display(void)
{
	...
	glPushMatrix();
		...
		myObj.draw(m_Smooth, m_Highlight);
	glPopMatrix();
	glutSwapBuffers ();
}
...
void keyboard (unsigned char key, int x, int y)
{
	...
	case 'O':
		...
		break;
	case 'L':
		myObj.loopSubdivision();
		break;
	case 'B':
		myObj.barycentricSubdivision();
		break;
	case '1':
	case '2':
	case '3':
...
int main(int argc, char **argv)
{
	...
	cout << "Welcome to Clarence's subdivision helper!" << endl;
	cout << endl;
	cout << "Provide a .obj or .off file" << endl;
	cout << "WARNING: Only use meshes that have triangles" << endl;
	cout << endl;
	...
	cout << "h: Toggle Edge Highlight"<<endl;
	cout << "L: Trigger Loop Subdivision" << endl;
	cout << "B: Trigger Barycentric Subdivision" << endl;
